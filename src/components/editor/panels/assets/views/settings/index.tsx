        ...
        >
          <TabsList>
            <TabsTrigger value="project-info">
              {t.editor.settings.tabs.projectInfo}
            </TabsTrigger>
            <TabsTrigger value="background">
              {t.editor.settings.tabs.background}
            </TabsTrigger>
          </TabsList>
        </Tabs>
      }
        ...
        <div className="flex flex-col">
          ...
          <Section showTopBorder={false}>
            <SectionHeader className="justify-between">
              <SectionTitle className="flex-1">
                {t.editor.settings.info.frameRate}
              </SectionTitle>
              <Select
                value={String(
              ...
              >
                <SelectTrigger className="bg-transparent border-none p-1 h-auto">
                  <SelectValue
                    placeholder={t.editor.settings.info.selectFrameRate}
                  />
                </SelectTrigger>
                <SelectContent>
          ...
          >
            <SectionHeader>
              <SectionTitle className="flex-1">
                {t.editor.settings.info.aspectRatio}
              </SectionTitle>
            </SectionHeader>

        ...
        <>
          <div className="flex items-center justify-between p-3 border-b">
            <h3 className="font-medium text-sm">
              {isExporting ? t.editor.export.exporting : t.editor.export.title}
            </h3>
          </div>
                    ...
                    <SectionContent>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="mp4">
                            {t.editor.export.formats.mp4}
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="webm" id="webm" />
                          <Label htmlFor="webm">
                            {t.editor.export.formats.webm}
                          </Label>
                        </div>
                      </RadioGroup>
                    </SectionContent>
                    ...
                    <SectionContent>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="low">
                            {t.editor.export.qualities.low}
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="medium" id="medium" />
                          <Label htmlFor="medium">
                            {t.editor.export.qualities.medium}
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="high" id="high" />
                          <Label htmlFor="high">
                            {t.editor.export.qualities.high}
                          </Label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="very_high" id="very_high" />
                          <Label htmlFor="very_high">
                            {t.editor.export.qualities.very_high}
                          </Label>
                        </div>
                      </RadioGroup>
                    </SectionContent>
